          ...
          <div className="card-body p-4">
            ...
            <div className="row">
              ...
              <div className="col-lg-7">
                  <h5 className="mb-3">
                    <Link to="/products" className="text-body"><i
                      className="fa fa-reply me-2"></i>Continue shopping
                    </Link>
                  </h5>
                <hr/>
                ...
                <div className="card bg-primary text-white rounded-3">
                  <div className="card-body">
                    ...
                    <form className="mt-4">
                      ...
                      <div className="form-outline form-white mb-4">
                        <input type="text" id="cardno" className="form-control form-control-lg" size="17"
                    ...
                    <button type="button" className="btn btn-info btn-block btn-lg">
                      <div className="d-flex justify-content-between">
                        <span>$4818.00</span>
                        <span>Shipping <i className="fas fa-long-arrow-alt-right ms-2"></i></span>
                      </div>
                    </button>
